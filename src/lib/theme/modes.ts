...
function lightShell(overrides: ThemeCssVars): ThemeCssVars {
  return {
    ...
    // 文字色用の濃い主役色。--t-primary は面や枠には良いが、
    // 小さい文字に使うとコントラスト 2.97:1 で HIG の 4.5:1 を割るため分離した（6.3:1）
    "--t-primary-text": "#4a6741",
    "--t-accent": "#7a9e7e",
    "--t-accent-bg": "#eef4ef",
    "--t-header-bg": "#f0ebe3",
